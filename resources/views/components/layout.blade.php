...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    @auth
                        ...
                        <li class="nav-item">
                            <span class="font-bold uppercase mt-20">
                        ...
                        <li class="nav-item">
                            <form class="inline" method="POST" action="/logout">
                                ...
                                <button type="submit" class="mt-20">
                                    <span class="p-1 px-4 badge-dark">
    ...
    {{-- yielding the content which is being passed in the section tag in the welcome page --}}
    {{-- @yield('content'); --}}

    {{-- we are replacing with slot because we moved the layout file into the component folder to clean up our code a bit more --}}
    {{ $slot }}
